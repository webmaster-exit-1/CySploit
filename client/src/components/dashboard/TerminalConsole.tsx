      ...
      <div className="p-4 border-b border-gray-800 flex justify-between items-center">
        ...
        {showControls && (
          <div className="flex space-x-1">
            <button type="button" className="w-3 h-3 rounded-full bg-destructive"></button>
            <button type="button" className="w-3 h-3 rounded-full bg-yellow-500"></button>
            <button type="button" className="w-3 h-3 rounded-full bg-green-500"></button>
          </div>
        )}
      </div>
